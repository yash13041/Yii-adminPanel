...
<div class="page-header page-header-default">
    <div class="page-header-content">
        <div class="page-title">
            <h4>
                <span class="text-semibold"><?= ucfirst(Yii::t('app', 'Users')); ?></span>
            </h4>
        </div>
    </div>
    <div class="breadcrumb-line">
        <ul class="breadcrumb">
            ...
            <li class="active"><?= Yii::t('app', 'Users'); ?></li>
        </ul>
    </div>
</div>
<!-- /page header  -->
...
<div class="content">
    <div class="panel panel-flat">
        ...
        <div class="panel-heading">
            ...
            <a href="<?= Yii::getAlias('@web').('users/add') ?>" class="btn btn-primary"><?= Yii::t('app', 'Add New')?><i class="icon-plus-circle2 position-right"></i></a>
            ...
            <table id="users_table" class="table table-bordered table-striped">
                <thead>
                    <tr>
                        ...
                        <th width="30%"><?= Yii::t('app', 'Firstname', 'Lastname'); ?></th>
                        <th width="30%"><?= Yii::t('app', 'Email'); ?></th>
                        <th width="10%"><?= Yii::t('app', 'Role'); ?></th>
                        <th width="12%"><?= Yii::t('app', 'Last Login'); ?></th>
                        <th width="8%"><?= Yii::t('app', 'Status');?></th>
                ...
                <tbody>
                    <?php foreach ($users as $user) : ?>
                        <tr>
                            ...
                            <td><?= ucfirst($user->firstname) . '&nbsp' . ucfirst($user->lastname); ?></td>
